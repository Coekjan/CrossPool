...
XPOOL_DEVICE_FN inline void Record::begin_atnagent(std::uint64_t local_trace_id,
  ...
  require_atnagent().timeline.template record<xpool::hooks::FabricAtnAgentProtocolEvent::Kind::SubmissionPrepared>(xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::submission_published() {
  require_atnagent()
      .timeline.template record<xpool::hooks::FabricAtnAgentProtocolEvent::Kind::SubmissionPublished, xpool::hooks::FabricAtnAgentProtocolEvent::Kind::SubmissionPrepared>(
...
XPOOL_DEVICE_FN inline void Record::admission_observed(const xpool::fabric::Admission &admission) {
  ...
  state.timeline.template record<xpool::hooks::FabricAtnAgentProtocolEvent::Kind::AdmissionObserved, xpool::hooks::FabricAtnAgentProtocolEvent::Kind::SubmissionPublished>(
      xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::input_ready_published() {
  require_atnagent()
      .timeline.template record<xpool::hooks::FabricAtnAgentProtocolEvent::Kind::InputReadyPublished, xpool::hooks::FabricAtnAgentProtocolEvent::Kind::AdmissionObserved>(
          xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::output_commit_observed(const xpool::fabric::OutputCommit &commit) {
  ...
  require_atnagent()
      .timeline.template record<xpool::hooks::FabricAtnAgentProtocolEvent::Kind::OutputCommitObserved, xpool::hooks::FabricAtnAgentProtocolEvent::Kind::AdmissionObserved>(
          xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::output_acknowledgement_published() {
  require_atnagent()
      .timeline.template record<xpool::hooks::FabricAtnAgentProtocolEvent::Kind::OutputAcknowledgementPublished,
                                xpool::hooks::FabricAtnAgentProtocolEvent::Kind::OutputCommitObserved>(xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::enqueued(std::uint64_t ready_ticket) {
  ...
  state.timeline.template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::Enqueued>(xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::scheduled(std::size_t executor_lane_index,
  ...
  state.timeline.template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::Scheduled, xpool::hooks::FabricCoordinatorProtocolEvent::Kind::Enqueued>(
      xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::admission_published() {
  require_coordinator()
      .timeline.template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::AdmissionPublished, xpool::hooks::FabricCoordinatorProtocolEvent::Kind::Scheduled>(
          xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::lane_execution_published() {
  require_coordinator()
      .timeline
      .template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::LaneExecutionPublished, xpool::hooks::FabricCoordinatorProtocolEvent::Kind::AdmissionPublished>(
          xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::ffnagent_completions_observed() {
  require_coordinator()
      .timeline.template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::FfnAgentCompletionsObserved,
                                xpool::hooks::FabricCoordinatorProtocolEvent::Kind::LaneExecutionPublished>(xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::output_commit_published() {
  require_coordinator()
      .timeline.template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::OutputCommitPublished,
                                xpool::hooks::FabricCoordinatorProtocolEvent::Kind::FfnAgentCompletionsObserved>(xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::output_acknowledgements_observed() {
  require_coordinator()
      .timeline.template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::OutputAcknowledgementsObserved,
                                xpool::hooks::FabricCoordinatorProtocolEvent::Kind::OutputCommitPublished>(xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::lane_released() {
  require_coordinator()
      .timeline
      .template record<xpool::hooks::FabricCoordinatorProtocolEvent::Kind::LaneReleased, xpool::hooks::FabricCoordinatorProtocolEvent::Kind::OutputAcknowledgementsObserved>(
          xpool::utils::time::now());
}
...
XPOOL_DEVICE_FN inline void Record::begin_ffnagent(std::uint64_t local_trace_id,
  ...
  require_ffnagent().timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::LaneExecutionObserved>(xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::input_ready_observed() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::InputReadyObserved, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::LaneExecutionObserved>(
          xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::routing_metadata_published() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::RoutingMetadataPublished, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::InputReadyObserved>(
          xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::routing_metadata_observed() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::RoutingMetadataObserved, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::InputReadyObserved>(
          xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::compute_started() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::ComputeStarted, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::InputReadyObserved>(
          xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::compute_completed() {
  require_ffnagent().timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::ComputeCompleted, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::ComputeStarted>(
      xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::partial_ready_published() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::PartialReadyPublished, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::ComputeCompleted>(
          xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::peer_partials_ready_observed() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::PeerPartialsReadyObserved, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::ComputeCompleted>(
          xpool::utils::time::now());
}

XPOOL_DEVICE_FN inline void Record::completion_published() {
  require_ffnagent()
      .timeline.template record<xpool::hooks::FabricFfnAgentProtocolEvent::Kind::CompletionPublished, xpool::hooks::FabricFfnAgentProtocolEvent::Kind::ComputeCompleted>(
          xpool::utils::time::now());
}
