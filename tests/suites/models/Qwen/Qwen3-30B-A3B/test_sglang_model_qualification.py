"""Explicit SGLang numerical and graph qualification for Qwen/Qwen3-30B-A3B."""
...
MODEL = E2eModel(model_id="Qwen/Qwen3-30B-A3B", architecture="Qwen3MoeForCausalLM")
SERVING_SLO = E2eManifest.load(E2E_MANIFEST_PATH).serving_slo
NUMERICAL_CASES: tuple[E2eFfnNumericalCase, ...] = (
    E2eFfnNumericalCase(
        id="qwen3-30b-a3b-ffn-numerical",
...
SERVING_CASES: tuple[E2eServingCase, ...] = (
    E2eServingCase(
        id="qwen3-30b-a3b-tp1-dp1-f2-e1",
