"""Explicit SGLang numerical and graph qualification for Qwen/Qwen2.5-0.5B."""
...
MODEL = E2eModel(model_id="Qwen/Qwen2.5-0.5B", architecture="Qwen2ForCausalLM")
SERVING_SLO = E2eManifest.load(E2E_MANIFEST_PATH).serving_slo
NUMERICAL_CASES: tuple[E2eFfnNumericalCase, ...] = (
    E2eFfnNumericalCase(
        id="qwen2-5-0-5b-ffn-numerical",
